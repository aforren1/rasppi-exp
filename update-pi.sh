...
sudo apt-get install -y --force-yes git portaudio19-dev subversion freeglut3-dev rhythmbox libusb-1.0 libdc1394-22-dev libgl1-mesa-dri mesa-demos octave liboctave-dev
